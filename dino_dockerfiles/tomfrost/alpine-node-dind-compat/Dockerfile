# Based on mhart's alpine-node builds at https://github.com/mhart/alpine-node
# Uses docker as base image to support node scripts that call docker commands
# Specifically, this image supports Binci: https://github.com/binci/binci v5.
FROM docker:latest
