...
ADD https://bintray.com/artifact/download/kurron/maven/org/kurron/example/monitor-mongodb/1.2.0.RELEASE/monitor-mongodb-1.2.0.RELEASE.jar /opt/example/application.jar
