...
RUN apt-get update && apt-get install -y -qq --no-install-recommends build-essential git wget curl unzip python php5-mysql php5-cli php5-cgi openjdk-7-jre-headless openssh-client python-openssl && apt-get clean
