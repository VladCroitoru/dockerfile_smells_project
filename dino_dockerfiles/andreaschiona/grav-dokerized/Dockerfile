...
# Install thema
RUN bin/gpm install antimatter
...
#RUN cp webserver-configs/nginx.conf /etc/nginx/sites-available/grav-site
...
VOLUME /root/.ssh/ /etc/nginx/ /usr/share/nginx/html/user/
