...
RUN apt-get install -qy openjdk-7-jre default-jre-headless default-jre unzip
RUN apt-get clean

# install madsonic
ADD http://madsonic.org/download/5.1/20140927_madsonic-5.1.5150.deb /tmp/madsonic.deb
