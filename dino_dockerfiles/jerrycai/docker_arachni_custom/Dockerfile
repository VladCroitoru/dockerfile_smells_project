...
COPY "$PWD"/custom/default.erb /usr/local/arachni/system/gems/gems/arachni-1.4/components/reporters/html/default.erb
COPY "$PWD"/custom/default/navigation.erb /usr/local/arachni/system/gems/gems/arachni-1.4/components/reporters/html/default/navigation.erb
