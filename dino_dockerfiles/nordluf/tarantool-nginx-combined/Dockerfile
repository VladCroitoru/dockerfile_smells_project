...
# ---[[START: Following lines were copied from https://hub.docker.com/r/tarantool/tarantool-nginx/~/dockerfile/
...
# ---]]END: Following lines were copied from https://hub.docker.com/r/tarantool/tarantool-nginx/~/dockerfile/
