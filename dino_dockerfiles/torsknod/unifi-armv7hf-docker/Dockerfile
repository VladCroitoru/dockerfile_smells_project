...
RUN apt-get -y update && apt-get -y dist-upgrade && apt-get -y install binutils default-jre-headless jsvc mongodb patch ufw && useradd --system --user-group --home-dir /usr/lib/unifi unifi
