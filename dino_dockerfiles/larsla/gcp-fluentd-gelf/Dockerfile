...
RUN apt-get -qq update && \
    ...
    td-agent-gem install --no-document gelf && \
    curl -s -o /etc/td-agent/plugin/out_gelf.rb https://raw.githubusercontent.com/emsearcy/fluent-plugin-gelf/master/lib/fluent/plugin/out_gelf.rb && \
    # Remove build tools
