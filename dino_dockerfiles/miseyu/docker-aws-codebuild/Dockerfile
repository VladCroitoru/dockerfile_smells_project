...
RUN apt-get update \
    && apt-get install -y --no-install-recommends \
       wget python python2.7-dev fakeroot ca-certificates tar gzip zip jq \
...
RUN curl -L -O https://github.com/miseyu/ecs-goploy/releases/download/0.4.0/ecs-goploy_0.4.0_linux_amd64.zip \
