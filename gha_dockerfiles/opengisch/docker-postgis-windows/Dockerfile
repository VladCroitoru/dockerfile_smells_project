...
ARG PGIS_VER
RUN $URL3 = $('http://download.osgeo.org/postgis/windows/pg{0}/archive/postgis-bundle-pg{1}x64.zip' -f $env:PGIS_VER.Substring(0, $env:PGIS_VER.IndexOf('-')), $env:PGIS_VER) ; \
