##
## ---- Base OS layer ----
## docker build -t styled-javascript-patterns --build-arg IMAGE_SOURCE=node --build-arg IMAGE_TAG=12-buster .
##
...
ARG NAME="javascript-patterns"
ARG VERSION="$(git describe --abbrev=0 --tag)"
ARG PACKAGE="AlexRogalskiy/javascript-patterns"
ARG DESCRIPTION="JavaScript Design Patterns"
