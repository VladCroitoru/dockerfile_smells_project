##
## ---- Base OS layer ----
## docker build -t styled-spark-patterns --build-arg IMAGE_SOURCE=node --build-arg IMAGE_TAG=12-buster .
##
...
ARG PACKAGE="AlexRogalskiy/spark-patterns"
ARG DESCRIPTION="Spark Design Patterns"
