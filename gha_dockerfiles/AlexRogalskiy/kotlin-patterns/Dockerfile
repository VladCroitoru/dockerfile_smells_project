##
## ---- Base OS layer ----
## docker build -t styled-kotlin-patterns --build-arg IMAGE_SOURCE=node --build-arg IMAGE_TAG=12-buster .
##
...
ARG NAME="kotlin-patterns"
ARG VERSION="$(git describe --abbrev=0 --tag)"
ARG PACKAGE="AlexRogalskiy/kotlin-patterns"
ARG DESCRIPTION="Kotlin Design Patterns"
